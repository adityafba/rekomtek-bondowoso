...
<body>
    ...
    <div class="relative bg-no-repeat bg-cover bg-fixed" style="background-image: url('{{ asset('assets/img/bendungan-bendo.jpeg') }}');">
    ...
    <section id="registration" class="bg-slate-300 scroll-mt-16">
        <div class="flex flex-col items-center">
            <div class="lg:w-[1170px] px-3 my-20 flex flex-col items-center">
                ...
                <a href="" class="bg-primary-50 font-medium py-4 px-10 rounded-full text-white mt-5">
                    Buat Permohonan
                </a>
            </div>
        </div>
